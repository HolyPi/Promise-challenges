 ...
 * 
 * It's more synchronous. It returns a promise that resolves or rejects
 * 
 * 
 ...
 * 
 * It prints out a pending state. 
 * 
 * 3. Uncomment block #2 and run the code again. What happens now?
 * 
 * After showing the pending state, it prints out HELLO THERE, DUCKY.
 * 
...
async function greetAndUppercase(name) {
    ...
    morespacing = await spacer(uppercasedGreeting)
    return morespacing
}
