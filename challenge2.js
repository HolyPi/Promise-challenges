 ...
 * 
 * When I run it, it prints out Hello there, Ducky. MAKE SCHOOL IS AWESOME!!!
 * 
 * 
 ...
 * 
 * It prints out "Received an error! Name must be a string!" Uppercase() doesn't run at all.
 * 
 ...
 *    run the code again.
 * 
 * It prints out "Hello there, Ducky" normally, but then prints out "Received an error! Argument to uppercaser must be string"
 * 
 * 
 * 
